...
def starter_claude_md(workdir, name, agent_type):
    ...
    path.write_text(
        ...
        f"## Bus\n"
        f"BUS DOCTRINE: write ULTRA-TERSE on the bus -- fragments, no articles or\n"
        f"filler, ids/numbers/names exact. Humans hear the writer's persona expansion;\n"
        f"the raw text stays the record. Prose on the bus = wasted tokens + slow speech.\n\n"
