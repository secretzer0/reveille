...
def starter_claude_md(workdir, name, agent_type):
    ...
    path.write_text(
        ...
        f"## Bus\n"
        f"BUS DOCTRINE: you write for AGENTS: caveman-ultra -- facts, ids, numbers,\n"
        f"no filler; the room hears you through the writer, do not write for the ear.\n"
        f"The raw text stays the record; the script is what the mouth said.\n\n"
